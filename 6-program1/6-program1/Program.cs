    ...
    public class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                os.AddOrder(order2);
                os.AddOrder(order3);
                os.Export(order1, order2, order3);
        ...
        public class OrderService
        {
            ...
            public List<Order> QueryByGoodsName(string goodsName)
            {
                ...
                /*void Export(Order order1, Order order2, Order order3)
                {
                    XmlSerializer xmlser = new XmlSerializer(typeof(List<Order>));
                    String xmlFileName = "s.xml";
                    Import(xmlser, xmlFileName, order1);
                    Import(xmlser, xmlFileName, order2);
                    Import(xmlser, xmlFileName, order3);
                    String xml = File.ReadAllText(xmlFileName);
                    Console.WriteLine(xml);
                }

                void Import(XmlSerializer ser, string fileName, object obj)
                {
            ...
            internal void Export(Order order1, Order order2, Order order3)
            {
                    XmlSerializer xmlser = new XmlSerializer(typeof(List<Order>));
                    String xmlFileName = "s.xml";
                    Import(xmlser, xmlFileName, order1);
